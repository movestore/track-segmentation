...
find_periods_move2 <- function(data, 
  ...
  # TODO: do we need both of these...? What are the most appropriate units?
  stops <- stops |>
    dplyr::mutate(
...
weighted_lon <- function(lon, weight) {
