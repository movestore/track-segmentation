...
proximity_distance_meters <- 5
### Define the minimum duration (Dur) for a stopover (units = hours)....
minimum_hours_threshold   <- 0.01666666
### ==========================================================================================================
